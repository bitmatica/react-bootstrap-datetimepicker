	    ...
	    return (
	          React.createElement("div", null, 
	            ...
	            React.createElement("div", {className: "input-group date", ref: "datetimepicker"}, 
	              React.createElement("span", {className: "input-group-addon", onClick: this.onClick, onBlur: this.onBlur, onMouseDown: onMouseDown, ref: "dtpbutton"}, React.createElement(Glyphicon, {glyph: "calendar"})), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	DateTimePicker = React.createClass({displayName: "DateTimePicker",
	  ...
	  render: function() {
	    var onMouseDown = function(e) {e.preventDefault()};
	    return (
	      React.createElement("div", {className: React.addons.classSet(this.props.widgetClasses), style: this.props.widgetStyle, onMouseDown: onMouseDown}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	DateTimePickerMonths = __webpack_require__(12);
